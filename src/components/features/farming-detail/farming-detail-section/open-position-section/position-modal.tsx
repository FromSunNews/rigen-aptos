...
function PositionContent({ onClose }: PositionContentProps) {
...
export default function PositionModal({ disabled }: PositionModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent>{open && <PositionContent onClose={() => setOpen(false)} />}</DialogContent>
    </Dialog>
  );
}
