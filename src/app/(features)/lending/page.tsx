...
export default function LendingPage() {
  return (
    <div className="relative mx-auto max-w-[1440px] px-4 mt-[160px] md:px-6 md:pt-12 ">
      ...
      <div className="space-y-12">
        ...
        <div className="flex flex-col items-center space-y-8">
          ...
          <div className="flex flex-col items-center space-y-3">
            <div className="flex items-center gap-4">
              ...
              <Typography variant="h1" className="bg-gradient-to-r from-white to-white/80 bg-clip-text text-6xl font-bold tracking-tight text-transparent">
                Lending
              </Typography>
            </div>
          ...
          {/* Stats Banner */}
          <div 
            className="relative w-full max-w-4xl rounded-[32px] bg-[#1D2E40]/40 backdrop-blur-xl before:absolute before:inset-0 before:-z-10 before:rounded-[32px] before:bg-gradient-to-r before:from-[#52AEFF]/10 before:to-transparent before:content-['']"
          >
        ...
        {/* Cards Grid */}
        <div className="grid md:px-16 grid-cols-1 place-items-center gap-8 pb-12 sm:grid-cols-2 lg:grid-cols-3">
