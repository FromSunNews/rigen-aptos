...
import { TransactionHash } from "@/components/shared/custom/transaction-hash";
import { InputViewFunctionData, MoveValue } from "@aptos-labs/ts-sdk";
import { EntryService } from "../services/entry-services";
import { ViewService } from "../services/view-services";
...
export function TransactionProvider({ children }: { children: ReactNode }) {
  ...
  const viewTx = useCallback(
    async (transaction: InputViewFunctionData, options?: TransactionOptions) => {
      try {
        // pre-check transaction
        preTransactionValidation();
