 ...
 * ))
 */
const middlewarePersist = <T>(f: StateCreator<T, [["zustand/devtools", never]], []>, name: string) =>
 ...
 * })))
 */
const middlewareImmer = <T>(f: StateCreator<T, [["zustand/immer", never]], []>) => devtools(immer(f));
